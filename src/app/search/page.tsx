...
const SUGGESTION_CHIPS = ['vision', 'streaming', 'tool use', 'MCP'];
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit}>
        <div className="relative rounded-xl border-2 border-[var(--border)] focus-within:border-[var(--accent)] bg-[var(--surface)]/30 px-4 py-3 transition-colors">
